...
class UserTest extends TestCase
{
    ...
    public function test_unauthenticated_user_cannnot_access_user_list_page(): void 
    {
    ...
    public function test_authenticated_regular_user_can_access_user_member_list_page(): void
    {
