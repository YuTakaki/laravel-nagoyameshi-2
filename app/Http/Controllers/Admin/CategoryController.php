...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.categories.index', compact('category'))->with('flash_message', 'カテゴリを登録しました。');
    }
    ...
    public function update(Request $request, Category $category)
    {
        ...
        return redirect()->route('admin.categories.index', compact('category'))->with('flash_message', 'カテゴリを編集しました。');
    }
